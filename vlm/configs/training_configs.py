...
@register_config
def b4_stable_short_c8(name: str) -> TrainingConfig:
    cfg = _base_receipt_config(name)
...
@register_config
def b4_stable_short_c4_ppo_ep_4(name: str) -> TrainingConfig:
    cfg = _base_receipt_config(name)
...
def b4_stable_short_ga4(name: str) -> TrainingConfig:
    ...
    return cfg
@register_config
def b16_stable_short_ga1(name: str) -> TrainingConfig:
    cfg = _base_receipt_config(name)

    cfg.sft.batch_size = 16
    cfg.sft.grad_accum_steps = 1
    cfg.sft.epochs = 15
    cfg.sft.learning_rate = 5e-5
    cfg.sft.weight_decay = 0.01
